...
function Home() {
  const actions = [
    { icon: <AccessibilityIcon />, name: 'Accesibilidad' },
    { icon: <CalendarTodayIcon />, name: 'Citas' },
  ...
  return (
    <div id="mainBody" style={{ position: 'relative' }} onClick={handleClose}>
      ...
      <Box sx={{ position: 'fixed', bottom: 16, right: 16, zIndex: 1000 }} onClick={(e) => e.stopPropagation()}>
