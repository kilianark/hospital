...
export class SearchRoomComponent {
  ...
  patient: PatientInterface[] = [
    ...
    { id: 1, patientCode: 654321, name: "Maria", surname1: "Pérez", surname2: "Castro", dni: "", cip: "", gender: "", phone: "621655788", email: "", age: 54, birthdate: new Date("1970-09-12"), country: countries[0].name, status: "Hospitalizado", address: "", emergencyContact: "", bed_id: 4011}
  ];
